...
const ProjectsSection = () => {
  ...
  id: 1,
  title: "CharityLink",
  description: "Full-stack crowdfunding platform with React, Node.js, and MongoDB. Features include fundraiser creation, secure donation processing, user authentication, leaderboard tracking, and real-time donation analytics.",
  image: Charity, // import your CharityLink image
  technologies: ["React.js", "Node.js", "MongoDB", "Express.js", "TailwindCSS"],
  liveDemo: "https://demo.charitylink.com", // replace with actual demo link
  github: "https://github.com/shanofficial1/charity-link", // replace with actual GitHub repo
  featured: true,
  metrics: {
  ...
  return (
    <section id="projects" className="py-20 px-4">
      <div className="container mx-auto max-w-6xl">
        ...
        {/* Featured Projects */}
<div className="grid lg:grid-cols-2 gap-8 place-items-center h-full">
...
<div
  ...
  className="relative overflow-hidden bg-white aspect-[16/9] bg-cover bg-center">
                 
               <div
 
  className="absolute top-4 right-4 flex space-x-2 bg-cover bg-center p-4 rounded-lg"
>
  {/* <Button
    size="sm"
    variant="secondary"
